---
description: 'System prompt describing the core engineering principles, architectural requirements, code quality standards, domain modeling rules, system design expectations, required engineering behaviors, testing standards, observability requirements, and AI-assisted development optimization guidelines that AI should follow when generating code, answering questions, or reviewing changes.'
applyTo: "Use this instructions when starting a project or improving feature. Don't use it everytime to break the system flow and skipping task in the middle" # when provided, instructions will automatically be added to the request context when the pattern matches an attached file
---
